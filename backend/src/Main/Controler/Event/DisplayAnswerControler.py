...
'''
def displays_curent_answer(request: Request, json, game: Game, socketio, message_received):
    ...
    party.send_event_to_player("Evt_party_send_new_aswers", map, socketio, None)